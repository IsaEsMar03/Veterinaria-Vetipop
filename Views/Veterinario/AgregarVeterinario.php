  ...
  <body>
   <div id="formulario">  
    <div id="cliente">
        ...
        <h2 style="color: #001e46; font-size: 30px; text-align: center;">Formulario de Registro Veterinarios</h2>
        <div class="container">
        <form action="../../Controllers/Veterinario/Insertar.php" method="POST">
            <div class="mb-3">
            ...
            <div class="container text-center">
                ...
                <a href="./GestionVeterinarios.php" class="btn btn-dark">Regresar</a>
            </div>
        </form>
    </div>
