...
<html lang="en">
  ...
  <body>
  <h1 class="bg-warning p-2 text-white text-center">Editar Veterinario!</h1>
    <br>
   <div id="formulario">  
    <div id="cliente">
        <div>
        ...
        <div class="container">
        <form action="../../Controllers/Veterinario/Editar.php" method="POST">
            <input type="hidden" name="Id" value="<?php echo $fila['id_veterinario']?>">
            <div class="mb-3">
            ...
            <div class="container text-center">
                ...
                <a href="../Veterinario/GestionVeterinarios.php" class="btn btn-dark">Regresar</a>
            </div>
        </form>
    </div>
